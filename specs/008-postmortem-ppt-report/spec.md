...
- **FR-003**: El informe DEBE incluir también las 4 gráficas propias del dashboard de postmortem para esa release: "Entradas, Resoluciones y Backlog", "Abiertas y Cerradas (solo PAP)", "Incidencias No Cerradas y Backlog Acumulado" y "Por Sistema".
