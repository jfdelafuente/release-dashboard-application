...
// ============================================================
const RAW_RELEASES = [
  ["2020R1", 2020, "9-feb.", "Febrero", 61, 46, 23, 17],
  ["2020R2", 2020, "1-mar.", "Marzo", 22, 18, 10, 9],
  ["2020R3", 2020, "29-mar.", "Marzo", 32, 26, 11, 9],
  ["2020R4", 2020, "26-abr.", "Abril", 53, 44, 5, 5],
  ["2020R6", 2020, "14-jun.", "Junio", 46, 36, 11, 9],
  ["2020R7", 2020, "2-ago.", "Agosto", 50, 32, 85, 70],
  ["2020R9", 2020, "27-sep.", "Septiembre", 49, 37, 71, 63],
  ["2020R11", 2020, "29-nov.", "Noviembre", 42, 36, 21, 17],
